...
BLOG_AUTHOR = "NLP Lemons"  # (translatable)
BLOG_TITLE = "NLP Lemons"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://nlplemons.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://kiselgof.theklezmerarchive.org/"
BLOG_EMAIL = "anna_rogers@uml.edu"
BLOG_DESCRIPTION = "Making progress in NLP, one failure at a time"  # (
# translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (#
        ("/tbd", "<i class='fa' style='font-size: 16px;'>Reproducibility</i>"),
        ("/tbd", "<i class='fa' style='font-size: 16px;'>Adaptation/Transfer</i>"),
        ("/tbd", "<i class='fa' style='font-size: 16px;'>New models</i>"),
        ("/tbd", "<i class='fa fa-search'></i>"),
